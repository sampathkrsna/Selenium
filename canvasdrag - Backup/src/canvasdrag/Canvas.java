...
System.out.println("Dragging succesfully ");
	...
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		driver.get("http://root.staging.kustommade.com/wardrobe/dimensions");
		System.out.println("Pass-1");
		Thread.sleep(5000);
		WebElement Subemail = driver.findElement(By.xpath("/html/body/div[1]/div[7]/div[1]/div[3]/form/div/div[1]/div[3]/div/ul/li[1]/select/option[3]"));
		...
		Thread.sleep(5000);
		WebElement Subemailbuton4 = driver.findElement(By.xpath(".//*[@id='mirrorToolBarItem']/a/div"));
		...
		Object val = ((JavascriptExecutor)driver).executeScript("return[ window.app.design.DOOR.length]");
		 ...
		 for(int i= 0;i<b;i++)
		 {
			...
			// System.out.println( of + "   " + a1);
			 WebElement canvas = driver.findElement(By.xpath(".//*[@id='wardrobeMirrorAccordionContent']/ul/li[2]/img"));
				WebElement canvavParent = driver.findElement(By.xpath(".//*[@id='appExternalCanvas']"));
				
				 
		Actions builder= new Actions(driver);
		builder.clickAndHold(canvas);
		builder.moveToElement(canvavParent, a1, 0);
