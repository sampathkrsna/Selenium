...
public class LandingPage {
	...
	public static void navigateLandingPage()throws InterruptedException{
...
//		try{
//			Thread.sleep(3000);
//			System.out.println(driver.findElement(By.xpath("//*[@id='submit_approve_access']")).isDisplayed());
//			if(driver.findElement(By.xpath("//*[@id='submit_approve_access']")).isDisplayed()){
